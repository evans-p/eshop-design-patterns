...
ALTER TABLE ESHOP_DESIGN_PATTERNS.TBCHARACTERISTIC ADD CONSTRAINT PKTBCHARACTERISTIC PRIMARY KEY(CHARACTERISTIC_ID);
ALTER TABLE ESHOP_DESIGN_PATTERNS.TBPRODUCT ADD CONSTRAINT PKTBPRODUCT PRIMARY KEY(PRODUCT_ID);
...
ALTER TABLE ESHOP_DESIGN_PATTERNS.TBCHARACTERISTIC ADD CONSTRAINT FKCHARACTERISTICPRODUCT FOREIGN KEY(PRODUCT_ID) REFERENCES ESHOP_DESIGN_PATTERNS.TBPRODUCT(PRODUCT_ID) ON DELETE CASCADE;
