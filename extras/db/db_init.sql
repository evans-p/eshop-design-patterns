...
ALTER TABLE ESHOP_DESIGN_PATTERNS.TBADDRESS ADD CONSTRAINT FKUSERPROFILEUSER FOREIGN KEY(USER_ID) REFERENCES ESHOP_DESIGN_PATTERNS.TBUSER(USER_ID) ON DELETE CASCADE;
