...
public class TestProductValidator {
  ...
  @Test(expected = RuleException.class)
  public void testValidateSKU_null() throws RuleException {
  ...
  @Test(expected = RuleException.class)
  public void testValidateSKU_empty() throws RuleException {
  ...
  @Test(expected = RuleException.class)
  public void testValidateInventoryLimit_null() throws RuleException {
  ...
  @Test(expected = RuleException.class)
  public void testValidateInventoryLimit_negative() throws RuleException {
  ...
  @Test(expected = RuleException.class)
  public void testValidateInventoryCount_null() throws RuleException {
  ...
  @Test(expected = RuleException.class)
  public void testValidateInventoryCount_negative() throws RuleException {
  ...
  @Test(expected = RuleException.class)
  public void testValidateCategory_null() throws RuleException {
  ...
  @Test(expected = RuleException.class)
  public void testValidatePrice_null() throws RuleException {
  ...
  @Test(expected = RuleException.class)
  public void testValidatePrice_negative() throws RuleException {
