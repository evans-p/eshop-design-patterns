...
public class TestOrderValidatorImpl {
  ...
  public void setUp() {
    ...
    sut.validator = mock(CartValidator.class);
  ...
  /**
   * Tests for {@link OrderValidatorImpl#apply()} no cart.
   */
  @Test(expected = RuleException.class)
  public void testApply_noCart() throws DataException, LogicException, RuleException {
    sut.input.setCart(null);
    sut.apply();
  }
